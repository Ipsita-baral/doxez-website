...
export default function DoctorOnboarding() {
  ...
  if (submitted) {
    return (
      <div style={{ minHeight: "80vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#f8fbff", padding: 24 }}>
        <motion.div
          initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}
          style={{ textAlign: "center", maxWidth: 540, width: "100%", background: "#fff", padding: "48px 32px", borderRadius: 32, boxShadow: "0 32px 80px -12px rgba(30,75,143,0.12)" }}
        >
          ...
          <h2 style={{ fontSize: "clamp(1.6rem, 5vw, 2rem)", fontWeight: 800, color: "#0b1f3a", marginBottom: 16 }}>Welcome to Doxez!</h2>
          <p style={{ color: "#64748b", lineHeight: 1.8, marginBottom: 36, fontSize: 15 }}>
            Thank you for registering, Dr. {formData.fullName.split(' ')[0]}. Our onboarding team will call you within the next 24 hours to complete your profile verification.
          </p>
          <button onClick={() => setSubmitted(false)} style={{ background: "#1e4b8f", color: "#fff", padding: "14px 40px", borderRadius: 14, fontWeight: 700, fontSize: 15, border: "none", cursor: "pointer" }}>
            Back to Page
          </button>
        </motion.div>
      </div>
    ...
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#fff", color: "#111827", overflowX: "hidden" }}>
      <style>{`
        ...
        @media (max-width: 720px) {
          ...
          .hero-section { padding: 40px 16px 50px !important; }
